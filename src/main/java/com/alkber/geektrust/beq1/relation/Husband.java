...
import com.alkber.geektrust.beq1.relation.base.Sibling;

import java.util.ArrayList;
import java.util.List;

public class Husband extends Relation {

	public Husband(Subject subject) {
	...
	public List<Subject> find() {
		...
		if(subject == null || subject.getSex() != Subject.FEMALE) {

			 return new ArrayList<Subject>();
		}

		return (subject.getSpouses());
	}
}
