...
/**
 * Create an instance of relation that doesn't exist.
 */
public class Test0000058 extends TestBase {

	public static void main(String args[]) throws IOException {

		RelationAliasIndexer.start();
		Relation relation = RelationFactory.create("GreatGrandFather", john);

		if (relation == null) {

			System.out.println("relation doesn't exist");
		}
