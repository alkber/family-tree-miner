...
/**
 * Create an instance of Sister relation for a male subject and search for all the sisters.
 */
public class Test0000056 extends TestBase {

	public static void main(String args[]) throws IOException {

		RelationAliasIndexer.start();
		Relation sister = RelationFactory.create("Sister", john);

		if (sister != null) {

			System.out.println(sister.find());
		}
